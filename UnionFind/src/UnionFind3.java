 ...
 * number of child elements of the roots, and places the one with fewer child elements under
 * the other one in order to reduce the max height of the tree.
 */
public class UnionFind3 implements UF {
    private int[] parent;
    // sz[i] is the number of child elements of ith element.
    private int[] sz;
    ...
    public void union(int p, int q) {
        ...
        // To reduce the height of the tree, make the root with a larger size the parent of the
        // other root.
